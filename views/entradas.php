  ...
  <div class="card">
    ...
    <form method="post" action="index.php?controller=entrada&action=salvar">
      ...
      <table class="table" id="tabela-itens">
       <thead>
  <tr>
    <th style="text-align: left; font-weight: 600;">Variação (SKU)</th>
    <th style="text-align: left; font-weight: 600;">Quantidade</th>
    <th style="text-align: left; font-weight: 600;">Custo Unitário (R$)</th>
  </tr>
</thead>
  <tbody>
